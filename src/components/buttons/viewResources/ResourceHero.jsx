...
export default function ResourceHero () {
  return (
    <div className='container mx-auto flex flex-col items-start justify-start gap-5 px-4 py-12 md:py-16 max-w-7xl'>
        <h1 className='text-xs md:text-sm text-[#f37421] font-bold uppercase tracking-widest'>Resources</h1>
        <div className='h-1.5 w-16 bg-[#f37421] rounded-full'></div>
        <p className='text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 tracking-tight leading-tight uppercase text-wrap'>Handpicked for You</p>
        <p className='text-base sm:text-lg text-slate-600 leading-relaxed max-w-4xl text-wrap'>Explore our carefully selected guides, articles, webinars, and practical tools designed to educate, inspire, and empower individuals with disabilities, their families, caregivers, and advocates.</p>
    </div>
  )
}